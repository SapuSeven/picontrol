...
$page = file_exists($page) ? $page : 'pages/404.php';
...
<html lang="en">
	<head>
		...
		<meta name="author" content="SapuSeven" />
		...
		<link href="css/picontrol.css" rel="stylesheet" media="screen" />
	...
	<body>
		<header>
			<div class="container">
				<a href="<?php echo INDEX; ?>"><img src="img/picontrol.png" alt="logo" /></a>
				<h1><a href="<?php echo INDEX; ?>">PiControl</a></h1>
	...
	<footer>
		<div class="container">
			<p>Sources are available on <a href="https://github.com/SapuSeven/picontrol">Github</a>.</p>
		</div>
	</footer>
